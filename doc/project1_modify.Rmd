...
iter <- 2000
thin <- 500 
seed <-list(2003,5,63,100001,765) # seed to start mcmcï¼? reproducible
nstart <- 5
best <- TRUE
...
###part3:word cloud####
Some codes are cited from https://www.kaggle.com/headsortails/
...
We can see â€œhardâ€? and â€œfreedomâ€? squaring up against one another; locked in an eternal battle in which â€œsuccessâ€? counters â€œgailâ€? and â€œunityâ€? rages against â€œbreakâ€?.
